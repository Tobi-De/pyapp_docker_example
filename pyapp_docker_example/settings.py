...
from pyapp_docker_example.core.sentry import sentry_profiles_sampler
from pyapp_docker_example.core.sentry import sentry_traces_sampler
...
APPS_DIR = BASE_DIR / "pyapp_docker_example"
...
ASGI_APPLICATION = "pyapp_docker_example.asgi.application"
...
LOCAL_APPS = [
    "pyapp_docker_example.core",
    "pyapp_docker_example.users",
]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "pyapp_docker_example": {
            "handlers": ["stdout"],
            "level": env.log_level("PYAPP_DOCKER_EXAMPLE_LOG_LEVEL", default="INFO"),
        },
    },
}
...
ROOT_URLCONF = "pyapp_docker_example.urls"

SECRET_KEY = env.str("SECRET_KEY", default="django-insecure-7y2u1nJhuh4agSBePC89XL35DXdZGBU3IPV9_qjwrco")
...
WSGI_APPLICATION = "pyapp_docker_example.wsgi.application"
...
ACCOUNT_FORMS = {"signup": "pyapp_docker_example.users.forms.UserSignupForm"}
